            ...
            <div class="sidebar-wrapper active">
               ...
               <div class="sidebar-menu">
                    ...
                    <ul class="submenu ">
                                ...
                                <li>
                                    <a href="supprimer-utilisateur.php">Ajouter Utilisateur</a>
                                </li>
...
$con = $c->connexionBDD();
                                               ...
                                               while($ligne = mysqli_fetch_array($res,MYSQLI_NUM)){
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="supprimer-utilisateur.php?id=<?php echo($ligne[0]); ?>"><img src="delete.png" width=30></a>
                                                    <a href="modifier-utilisateur.php?id=<?php echo($ligne[0]); ?>"> <img src="update.jpg" width=40></a> </th>
                                                </tr>
                                                <?php
                                                    }
                                                ?>
