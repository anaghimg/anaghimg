...
$con = $c->connexionBDD();
                                               ...
                                               while($ligne = mysqli_fetch_array($res,MYSQLI_NUM)){
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="supprimerpanne.php?id=<?php echo($ligne[0]); ?>"><img src="delete.png" width=30></a>
                                                    <a href="modifier-panne.php?id=<?php echo($ligne[0]); ?>"> <img src="update.jpg" width=40></a> </th>
                                                </tr>
                                                <?php
                                                    }
                                                ?>
