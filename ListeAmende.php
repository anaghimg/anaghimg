                    ...
                    <ul class="submenu ">
                            ...
                            <a href="index" class='sidebar-link'>
                             ...
                             <ul class="submenu ">
                                ...
                                <li>
                                <a href="Supprimer-panne.php">supprimer une panne</a>
                              </li>
                              <li>
...
$con = $c->connexionBDD();
                                               ...
                                               while($ligne = mysqli_fetch_array($res,MYSQLI_NUM)){
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="supprimer-amende.php?id=<?php echo($ligne[0]); ?>"><img src="delete.png" width=30></a>
                                                    <a href="modifier-amende.php?id=<?php echo($ligne[0]); ?>"> <img src="update.jpg" width=40></a> </th>
                                                </tr>
