...
$con = $c->connexionBDD();
                                               ...
                                               while($ligne = mysqli_fetch_array($res,MYSQLI_NUM)){
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="supprimer-utilisateur.php?id=<?php echo($ligne[6]); ?>"><img src="delete.png" width=30></a>
                                                    <a href="modifier-utilisateur.php?id=<?php echo($ligne[6]); ?>"> <img src="update.jpg" width=40></a> </th>
                                                </tr>
                                                <?php
                                                    }
                                                ?>
