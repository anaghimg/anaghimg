    ...
    <div id="app">
                     ...
                     <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub ">
                            ...
                            <ul class="submenu ">
                                ...
                                <li>
                                    <a href="ajout_demande.php">Ajouter demande de reparation</a>
                                </li>
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <div class="card-body">
                    <form class="form form-horizontal" name="form1" action="ajout_demande1.php" method="post">
                        ...
                        <div class="col-md-8 form-group">
                            <input text="text" id="id" name="id" class="form-control" placeholder="id">
                          </input>
                        </div>
                         <div class="col-md-4">
                            <label>libelle</label>
                        ...
                        <div class="col-md-8 form-group">
                            <input text="text" id="libelle" name="libelle" class="form-control" placeholder="libelle">
                          </input>
                        </div>
                         <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                            <input text="text" id="observation" name="observation" class="form-control" placeholder="observation">
                          </input>
                        </div>
                         <div class="col-md-4">
                        ...
                        <div class="col-md-8 form-group">
                            <input text="datetime" id="date" name="date" class="form-control" placeholder="date">
                          </input>
                            </div>
                        ...
                        <div class="col-md-8 form-group">
                            <input text="text" id="id_vehicule" name="id_vehicule" class="form-control" placeholder="id_vehicule">
                          </input>
                            </div>
