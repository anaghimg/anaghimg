        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                <div class="page-title">
                    <h3>Listes des demandes de reparation</h3>
                </div>
...
$con = $c->connexionBDD();
                                               ...
                                               while($ligne = mysqli_fetch_array($res,MYSQLI_NUM)){
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a href="Supprimer-demande.php?id=<?php echo($ligne[0]); ?>"><img src="delete.png" width=30></a>
                                                    <a href="modifier-demande.php?id=<?php echo($ligne[0]); ?>"> <img src="update.jpg" width=40></a> </th>
                                                </tr>
                                                <?php
                                                    }
                                                ?>
